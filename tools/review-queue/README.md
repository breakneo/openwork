...
The offline generator emits conservative agent-initiated conditional plans, never executes them. These offline plans are not the LIVE per-item human-approval authority described under Incident attention below:
