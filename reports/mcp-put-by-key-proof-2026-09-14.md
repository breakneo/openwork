...
| --- | --- | --- | --- |
| 1 PUT `/v1/mcp-connections/by-key/demo-proof-1`, no-auth HTTP MCP | 201, ID/key | 201, `emc_` ID, requested key; live validation completed | Passed |
