...
- New C 48s / D 50s COMPLETE films use only `reports/demo/dashboard-demo-proof/2026-09-15T12-38-23.971Z/` captures, original finalized runner hash, and owner/media bindings. [Players and detailed receipts](https://github.com/different-ai/openwork/pull/5017#issuecomment-5680490215). Prior PARTIALs unchanged.
