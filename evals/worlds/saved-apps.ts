...
export async function savedAppCreation(seed: Seed) {
  const den = await seed.den({
    env: { DEN_GENERATED_ARTIFACT_VIEWS_ENABLED: "true", DEN_DASHBOARDS_ENABLED: "true", DEN_DASHBOARD_ADMIN_ONLY_FROM_DESKTOP_VERSION: "0.17.0", DEN_BETTER_AUTH_COOKIE_DOMAIN: "daytonaproxy01.net" },
