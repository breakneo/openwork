...
const definitions = {
  'open-coworker-local-first.e2e.test.ts': {
    cases: [{ id: 'COWORKER-SHARED', engines: ['v2'], optIns: ['OPENWORK_EVAL_COWORKER_LOOPBACK_ONLY'], example: { placement: '--local', engine: 'v2' } }],
  },
