    ...
    <div className={`${surfaceCardClass} space-y-3 p-4`}>
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1 text-[13px] leading-relaxed text-dls-secondary">
          ...
          <div>Each conversation uses its own tabs in the built-in browser. Allow browser control once for the thread to navigate, read, click, type and scroll. Choose Take over to revoke control and sign in; Resume browser lets the thread request access again. Website tools and sharing their results still need separate approval.</div>
