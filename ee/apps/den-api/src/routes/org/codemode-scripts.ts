  ...
  app.post(
    ...
    describeRoute({
      ...
      responses: {
        ...
        403: jsonResponse("Only organization owners and admins can share apps.", forbiddenSchema),
