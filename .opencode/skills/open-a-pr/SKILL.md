...
CI runs every spec the PR changes and posts the report as a comment
(`publish-evidence`). The body names the spec and says what the reader will
see; it does not copy verdicts, SHAs, screenshots or links, which go stale.
